...
const Places = () => {
  return (
    <div className="places mt-3 mb-3">
      <div
        className="placeshero text-white bg-image w-100 text-center px-4 py-5 my-5"
        style={{
          backgroundImage:
            "url(" +
      ...
      >
        <h1 className="display-5 fw-bold">Make your own places !</h1>
